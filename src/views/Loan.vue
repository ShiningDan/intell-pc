<template>
  <div class="x-views-loan-main">
    ...
    <div class="x-views-loan-advantage x-views-loan-section" v-if="advantages.length > 0">
      ...
      <div class="x-views-loan-content-main">
        ...
        <div class="x-views-loan-car x-views-loan-section" v-if="carloans.length > 0">
          ...
          <div class="x-views-loan-car-main">
            <v-loan-tab v-for="carloan in carloans" :key="carloan.id" :data="carloan"></v-loan-tab>
          </div>
        </div>
      </div>
